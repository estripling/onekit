...
@pytest.mark.parametrize(
    ...
    [
        # zero duration
        ("13:00:00", "13:00:00", "PT0S"),
        ("13:00:00", "T13:00:00", "PT0S"),
        ("T13:00:00", "13:00:00", "PT0S"),
        ("T13:00:00", "T13:00:00", "PT0S"),
        ("2024-07-01", "2024-07-01", "PT0S"),
        ("2024-07-01T13:00:00", "2024-07-01T13:00:00", "PT0S"),
        ("2024-07-01T13:00:00Z", "2024-07-01T13:00:00Z", "PT0S"),
        ("2024-07-01T13:00:00Z+01:00", "2024-07-01T13:00:00Z+01:00", "PT0S"),
        ("2024-07-01T13:00:00+01:00", "2024-07-01T13:00:00+01:00", "PT0S"),
        ("2024-07-01T13:00:00.10", "2024-07-01T13:00:00.10", "PT0S"),
        # 1x date change
        ("2024-07-01", "2025-07-01", "P1Y"),
        ("2024-07-01", "2024-08-01", "P1M"),
        ("2024-07-01", "2024-07-02", "P1D"),
        ("2024-07-01T13:00:00", "2025-07-01T13:00:00", "P1Y"),
        ("2024-07-01T13:00:00", "2024-08-01T13:00:00", "P1M"),
        ("2024-07-01T13:00:00", "2024-07-02T13:00:00", "P1D"),
        # 2x date changes
        ("2024-07-01", "2025-08-01", "P1Y1M"),
        ("2024-07-01", "2025-07-02", "P1Y1D"),
        ("2024-07-01", "2024-08-02", "P1M1D"),
        ("2024-07-01T13:00:00", "2025-08-01T13:00:00", "P1Y1M"),
        ("2024-07-01T13:00:00", "2025-07-02T13:00:00", "P1Y1D"),
        ("2024-07-01T13:00:00", "2024-08-02T13:00:00", "P1M1D"),
        # 3x date changes
        ("2024-07-01", "2025-08-02", "P1Y1M1D"),
        ("2024-07-01T13:00:00", "2025-08-02T13:00:00", "P1Y1M1D"),
        # 1x time change
        ("13:00:00", "14:00:00", "PT1H"),
        ("13:00:00", "13:01:00", "PT1M"),
        ("13:00:00", "13:00:01", "PT1S"),
        ("2024-07-01T13:00:00", "2024-07-01T14:00:00", "PT1H"),
        ("2024-07-01T13:00:00", "2024-07-01T13:01:00", "PT1M"),
        ("2024-07-01T13:00:00", "2024-07-01T13:00:01", "PT1S"),
        # 2x time changes
        ("13:00:00", "14:01:00", "PT1H1M"),
        ("13:00:00", "14:00:01", "PT1H1S"),
        ("13:00:00", "13:01:01", "PT1M1S"),
        ("2024-07-01T13:00:00", "2024-07-01T14:01:00", "PT1H1M"),
        ("2024-07-01T13:00:00", "2024-07-01T14:00:01", "PT1H1S"),
        ("2024-07-01T13:00:00", "2024-07-01T13:01:01", "PT1M1S"),
        # 3x time changes
        ("13:00:00", "14:01:01", "PT1H1M1S"),
        ("2024-07-01T13:00:00", "2024-07-01T14:01:01", "PT1H1M1S"),
        # 1x date time + 3x time changes
        ("2024-07-01T13:00:00", "2025-07-01T14:01:01", "P1YT1H1M1S"),
        ("2024-07-01T13:00:00", "2024-08-01T14:01:01", "P1MT1H1M1S"),
        ("2024-07-01T13:00:00", "2024-07-02T14:01:01", "P1DT1H1M1S"),
        # 2x date times + 3x time changes
        ("2024-07-01T13:00:00", "2025-08-01T14:01:01", "P1Y1MT1H1M1S"),
        ("2024-07-01T13:00:00", "2025-07-02T14:01:01", "P1Y1DT1H1M1S"),
        ("2024-07-01T13:00:00", "2024-08-02T14:01:01", "P1M1DT1H1M1S"),
        # 3x date times + 3x time changes
        ("2024-07-01T13:00:00", "2025-08-02T14:01:01", "P1Y1M1DT1H1M1S"),
        # microseconds
        ("2024-07-01T13:00:00.10", "2024-07-01T13:00:00.20", "PT0S"),
        # arbitrary changes
        ("2024-07-01T13:00:00", "2024-07-02T14:00:00", "P1DT1H"),
        ("2024-07-01T13:00:00", "2024-07-02T15:15:00", "P1DT2H15M"),
        ("2024-07-01T13:00:00", "2024-07-02T15:15:30", "P1DT2H15M30S"),
        ("2020-04-06T15:00:07Z", "2021-07-28T19:18:02+00:00", "P1Y3M22DT4H17M55S"),
        (
...
def test_isoduration(start: str, end: str, expected: str):
    actual = tk.isoduration(start, end)
    assert actual == expected

    actual = tk.isoduration(end, start)
    assert actual == expected
